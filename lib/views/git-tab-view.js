    ...
    return (
      <div className="github-Git too-many-changes">
        ...
        <div className="initialize-repo-description">
          ...
          to display in Atom-ng. Ensure that you have set up an appropriate <code>.gitignore</code> file.
        </div>
      </div>
    );
  }
  ...
  renderUnsupportedDir() {
    return (
      <div className="github-Git unsupported-directory">
        ...
        <div className="initialize-repo-description">
          Atom-ng does not support managing Git repositories in your home or root directories.
        </div>
      </div>
    );
  }
